...
export class VideoPlayStatsComponent implements OnInit {
  ...
  ngOnInit() {
   this.service.getVideoPlayStats(this.email_id, this.namespace).subscribe((dataArray) => {
