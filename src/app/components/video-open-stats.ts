...
export class VideoOpenStatsComponent implements OnInit {
  ...
  ngOnInit() {
    this.service.getVideoOpenStats(this.email_id, this.namespace).subscribe((dataArray) => {
